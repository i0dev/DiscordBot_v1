...
public class Fun_Dice extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (message.length > 0 && message[0].equalsIgnoreCase(Bot.BotPrefix + "dice")) {
        ...
        if (message.length == 1 && message[0].equalsIgnoreCase(Bot.BotPrefix + "dice")) {
            if (isAllowed) {
                ...
                EmbedRules.setColor(Color).setDescription("**"+e.getAuthor().getAsTag() + "**, You rolled a die, and you rolled a **" + Coin + "**");
