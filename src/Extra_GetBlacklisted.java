...
public class Extra_GetBlacklisted extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (message.length > 0 && message[0].equalsIgnoreCase(Bot.BotPrefix + "getblacklisted")) {
        ...
        if (message.length == 1 && message[0].equalsIgnoreCase(Bot.BotPrefix + "getBlacklisted")) {
            if (isAllowed) {
                ...
                String BlacklistStirng = ">>> ";
                for (String s : BlacklistedGet) {
                    BlacklistStirng = BlacklistStirng + "**" + e.getGuild().getMemberById(s).getUser().getAsTag() + "**\n";
                }
                if (BlacklistStirng.equals(">>> ")) {
                    BlacklistStirng = "**No one is currently blacklisted!**";
                }

                BlacklistedGet.clear();
                EmbedBuilder EmbedRules = new EmbedBuilder();
                EmbedRules.setTitle("Blacklist");
                EmbedRules.setColor(Color);
                EmbedRules.addField("List of blacklisted users:", BlacklistStirng, false);
